...
public class Ontology {
    ...
    public Ontology(CanmedCsvParser NDCparser, CanmedCsvParser HCPCSparser) {
    ...
    private void createNDCconcepts(gov.nih.nci.evs.canmed.CanmedCsvParser parser) {
        ...
        for (List<String> dataLine : parser.getLineByLineData()) {
            ...
            HierarchicalConcept DrugNameConcept = null;
            NdcProduct ProductConcept = null;
            NdcPackage PackageConcept = null;
            String minorCode = "";
            String majorCode = "";
            String drugName="";
            try {
                ...
                if (major.length() > 0) {
                    majorCode = "NDC_" + CanmedToOwl.parseConceptCode(major);
                ...
                if (minor.length() > 0) {
                    minorCode = "NDC_" + CanmedToOwl.parseConceptCode(minor);
                ...
                String genericName = propertyValueList.get(Constants.NDC_DRUG_NAME);

                if (genericName.isEmpty()) {
                    String tmppackage = propertyValueList.get(Constants.NDC_PACKAGE);
                    drugName = propertyValueList.get(Constants.NDC_BRAND_NAME);
                    System.out.println("Generic name empty for:"+ tmppackage+ " "+drugName);
                } else {
                ...
                if (concepts.containsKey(drugNameCode)) {
                    ...
                    System.out.println("Drug name empty for code:"+minorCode);
                }
                ...
                if (concepts.containsKey(productCode)) {
                    ...
                    ProductConcept.setGenericName(genericName);
                }

                if (DrugNameConcept != null && ProductConcept != null) {
                ...
                if (concepts.containsKey(packageCode)) {
                    ...
                    PackageConcept.setGenericName(genericName);
                }
                ...
                if (PackageConcept != null && ProductConcept != null) {
    ...
    private void createHCPCSconcepts(CanmedCsvParser parser) {
        ...
        for (List<String> dataLine : parser.getLineByLineData()) {
            ...
            try {
                ...
                if (major.length() > 0) {
                    majorCode = "HCPCS_" + CanmedToOwl.parseConceptCode(major);
                    if (majorCode != null) {
                        if (concepts.containsKey(majorCode)) {
                            MajorConcept = concepts.get(majorCode);
                        } else {
                ...
                if (minor.length() > 0) {
                    minorCode = "HCPCS_" + CanmedToOwl.parseConceptCode(minor);
                ...
                String genericName = propertyValueList.get(Constants.HCPCS_DRUG_NAME);

                if (genericName.isEmpty()) {
                    String tmppackage = generateHCPCSpackageCode(propertyValueList);

                    drugName = propertyValueList.get(Constants.HCPCS_BRAND_NAME);
                    System.out.println("Generic name empty for:"+ tmppackage+ " "+drugName);
                } else {
                    drugName = genericName;
                }
